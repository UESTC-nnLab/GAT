...
class BoxMultiHeadedAttention(nn.Module):
    ...
    def __init__(self, h, d_model, dropout=0.1, use_glu=1, dropout_glu=0.5):
        ...
        if self.use_glu:
            ...
            # self.fc_gate = nn.Linear(d_model, d_model, bias=False)
...
class GATModel(AttModel):
    def __init__(self, opt):
        super(GATModel, self).__init__(opt)
        self.num_layers = 1
    ...
    # on machine12:
    # CUDA_VISIBLE_DEVICES=0,1 nohup sh train_GAT1.sh > train_GAT_enc_glu_beam5_3l.log &

    # CUDA_VISIBLE_DEVICES=2,3 nohup sh train_GAT0.sh > train_GAT_enc_glu_beam5_3l_1_rl.log &



    # on machine11:
    # CUDA_VISIBLE_DEVICES=4,5 nohup sh train_GAT0.sh > train_GAT_enc_glu_beam5_3l_1.log &
    # CUDA_VISIBLE_DEVICES=6,7 nohup sh train_GAT1.sh > train_GAT_enc_glu_beam5_3l.log &

    # on machine:
    # nohup sh train_GAT3.sh > train_GAT_enc_glu_beam5_3l_more.log &
    #  sh train_GAT3.sh
