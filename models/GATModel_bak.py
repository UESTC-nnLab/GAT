...
class GATCore(nn.Module):
    def __init__(self, opt):
        ...
        self.encoder = BoxEncoder(BoxEncoderLayer(self.d_model, box_attn, c(ff), 0.1), 3)
        # self.encoder = BoxEncoder(BoxEncoderLayer(self.d_model, box_attn, None, 0.1), 3)  # no ff

        # Self-attention module
        self.decoder = MyDecoder(MyDecoderLayer(self.d_model, attn, c(ff), 0.1), 3)
...
class GATModel(AttModel):
    ...
    # CUDA_VISIBLE_DEVICES=0 nohup sh train_GAT0.sh > train_GAT_both_glu_rl.log &

    # CUDA_VISIBLE_DEVICES=1 nohup sh train_GAT1.sh > train_GAT_both_glu1_rl.log &

    # CUDA_VISIBLE_DEVICES=2 nohup sh train_GAT2.sh > train_GAT_both_glu_drop5.log &

    # CUDA_VISIBLE_DEVICES=0 nohup sh train_GAT1.sh > train_GAT_enc_glu1_rl.log &

    # CUDA_VISIBLE_DEVICES=1 nohup sh train_GAT0.sh > train_GAT_enc_glu2.log &

    # on machine11:
    # CUDA_VISIBLE_DEVICES=7 nohup sh train_GAT0.sh > train_GAT_enc_glu.log &
    # CUDA_VISIBLE_DEVICES=7  sh train_GAT0.sh