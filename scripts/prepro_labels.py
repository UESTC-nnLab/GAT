...
if __name__ == "__main__":
 ...
 # python scripts/prepro_labels.py --input_json data/dataset_coco.json --images_root /hdd/wangchi/data/coco/ --output_json data/cocotalk1.json --output_h5 data/cocotalk1
