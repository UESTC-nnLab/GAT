...
def train(opt):
    ...
    # att_feat_size = att_feat_size + semantic_feat_size(300+300) + geometrical_feat_size(5)
    ...
    if opt.noamopt:
        assert opt.caption_model in ['transformer', 'aoa', 'gat', 'mh', 'mh_new',
                                     'mh_new1'], 'noamopt can only work with transformer'
