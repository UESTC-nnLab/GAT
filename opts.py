...
def parse_opt():
    ...
    parser.add_argument('--d_model', type=int, default=512,
                        help='self attention model size')
    parser.add_argument('--N_model', type=int, default=3,
                        help='num of self Nattention model layers')
    parser.add_argument('--num_heads', type=int, default=8,
                        help='number of attention heads?')
    parser.add_argument('--use_glu_enc', type=int, default=1,
                        help='use GLU in the refining encoder?')
    parser.add_argument('--use_glu_dec', type=int, default=1,
                        help='use GLU in the decoder?')
    parser.add_argument('--drop_att', type=float, default=.1,
                        help='dropout in att_embed')
